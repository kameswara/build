...
export const dialerFolder: string = "./src/test/TestFiles/dialerFolder";
export const propertiesFolder: string = "./src/test/TestFiles/PropertiesFolder";
export const errorsFolder: string = "./src/test/errors";
